...
layout: default
title: ModRef 2020
redirect_from: /ModRef2020.html
---

ModRef 2020 is the 19th in a [series of workshops on Constraint Modelling and Reformulation](https://archive.modref.org).
ModRef has always been co-located with the [Constraint Programming (CP) conference](https://www.a4cp.org/) in the past.
...
| 13:45 | Mateusz Ślażyński, Salvador Abreu and Grzegorz J. Nalepa | Specifying Local Search Neighborhoods from a Constraint Satisfaction Problem Structure [(paper)](https://archive.modref.org/files/papers/2020/ModRef2020-02-Specifying-Local-Search-Neighborhoods-from-a-Constraint-Sati.pdf) [(video)](https://www.youtube.com/watch?v=5RrMSVbZzqw) |
| 14:00 | Mikael Z. Lagerkvist and Magnus Rattfeldt | Half-checking propagators [(paper)](https://archive.modref.org/files/papers/2020/ModRef2020-02-Specifying-Local-Search-Neighborhoods-from-a-Constraint-Sati.pdf) [(video)](https://www.youtube.com/watch?v=NlQI6Qfsy24) [(slides)](https://archive.modref.org/files/slides/2020/ModRef2020-03-Half-checking-propagators.pdf) |
| 14:15 | Gökberk Koçak, Özgür Akgün, Nguyen Dang and Ian Miguel | Efficient Incremental Modelling and Solving [(paper)](https://archive.modref.org/files/papers/2020/ModRef2020-04-Efficient-Incremental-Modelling-and-Solving.pdf) [(video)](https://www.youtube.com/watch?v=cbCNTeQQ6DQ) |
| 14:30 | *Break* | |
| 15:00 | Vitaly Lagoon and Amit Metodi| Deriving Optimal Multiplication-by-Constant Circuits With A SAT-based Constraint Engine [(paper)](https://archive.modref.org/files/papers/2020/ModRef2020-05-Deriving-Optimal-Multiplication-by-Constant-Circuits-With-A.pdf) [(video)](https://www.youtube.com/watch?v=1oUXHDxnGcY)|
| 15:15 | Federico Toffano, Nic Wilson and Paolo Viappiani | Efficient Exact Computation of Setwise Minimax Regret [(paper)](https://archive.modref.org/files/papers/2020/ModRef2020-05-Deriving-Optimal-Multiplication-by-Constant-Circuits-With-A.pdf) [(video)](https://www.youtube.com/watch?v=fdnFf1LCuKw)|
| 15:30 | Özgür Akgün, Nguyen Dang, Joan Espasa, Ian Miguel, András Salamon and Christopher Stone | Exploring Instance Generation for Automated Planning [(paper)](https://archive.modref.org/files/papers/2020/ModRef2020-06-Efficient-Exact-Computation-of-Setwise-Minimax-Regret.pdf) [(video)](https://www.youtube.com/watch?v=ec2IY_c8nK4) [(slides)](https://archive.modref.org/files/slides/2020/ModRef2020-07-Exploring-Instance-Generation-for-Automated-Planning.pdf) |
| 15:45 | *Break* | |
| 16:15 | *Invited talk:* Tias Guns | Hybrid Prediction and Constraint Solving [(video)](https://www.youtube.com/watch?v=9EE5JR1Y8Po) |
| 17:00 | Maria Andreina Francisco Rodriguez and Ola Spjuth | A Constraint Programming Approach to Microplate Layout Design [(paper)](https://archive.modref.org/files/papers/2020/ModRef2020-09-A-Constraint-Programming-Approach-to-Microplate-Layout-Desig.pdf) [(video)](https://www.youtube.com/watch?v=naddH2TQIjE) [(slides)](https://archive.modref.org/files/slides/2020/ModRef2020-09-A-Constraint-Programming-Approach-to-Microplate-Layout-Desig.pdf) |
| 17:15 | Helmut Simonis, Simon de Givry, Thomas Schiex and Andreas Schutt | Modelling the Conference Paper Assignment Problem [(paper)](https://archive.modref.org/files/papers/2020/ModRef2020-09-A-Constraint-Programming-Approach-to-Microplate-Layout-Desig.pdf) [(video)](https://www.youtube.com/watch?v=lYIMaCj4Hto) |
| 17:30 | Patrick Spracklen, Nguyen Dang, Özgür Akgün and Ian Miguel | Towards Portfolios of Streamlined Constraint Models: A Case Study with the Balanced Academic Curriculum Problem [(paper)](https://archive.modref.org/files/papers/2020/ModRef2020-11-Towards-Portfolios-of-Streamlined-Constraint-Models-A-Case-S.pdf) [(video)](https://www.youtube.com/watch?v=WtDwVyf7Gmw) |
...
The ModRef workshop has been running for 19 years and has hosted many interesting presentations.
 ...
 - The 2019 workshop page was hosted at ModRef2019.github.io, and is duplicated [here](https://2019.modref.org).
